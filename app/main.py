...
if __name__ == "__main__":
    ...
    gradient_detector_settings = application_settings.get("gradient_detector_settings")
    rolling_buffer_manager_settings = application_settings.get("rolling_buffer_manager_settings")
    persistent_object_tracker_settings = application_settings.get("persistent_object_tracker_settings")
    ...
    for frame_id, frame in streamer.stream():
        ...
        streamer.display(frame, reconstructed_background)
